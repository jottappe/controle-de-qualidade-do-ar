    ...
    if menu == 1:
        ...
        while True:
            try:
                ...
                if o3 is None:
                    o3 = float(input("Digite a medida de ozônio [03]:"))
                if co is None:
                    co = float(input("Digite a medida de monóxido de Carbono [CO]: "))
                if no2 is None:
                    no2 = float(
                        input("Digite a medida de dióxido de Nitrogênio [NO2]: ")
                    )
                if so2 is None:
                    so2 = float(input("Digite a medida de dióxido de Enxofre [SO2]: "))
                else:
                    break
            except:
    ...
    # Classificar amostras
        ...
        try:
            ...
            if amostras is None:
                ...
                print("\n")
                if qualidade_ar == 5:
                    print(f"A qualidade do ar está: {VERMELHO}PÉSSIMA{LIMPAR}!")
                    print(
                        "Toda a população pode apresentar sérios riscos de manifestações de doenças respiratórias e cardiovasculares. Aumento de mortes prematuras em pessoas de grupo sensíveis."
                    )
                elif qualidade_ar == 4:
                    print(f"A qualidade do ar está: {ROXO}MUITO RUIM{LIMPAR}!")
                    print(
                    ...
                    print(f"A qualidade do ar está: {AMARELO}MODERADA{LIMPAR}!")
                    print(
